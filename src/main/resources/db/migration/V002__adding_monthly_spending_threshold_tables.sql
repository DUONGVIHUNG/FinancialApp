CREATE TABLE current_monthly_spending_threshold_limits(
    ...
    CONSTRAINT current_monthly_spending_threshold_limits_fkey_users FOREIGN KEY(user_id)
...
CREATE TABLE spending_threshold_records(
    ...
    CONSTRAINT spending_threshold_records_fkey_users FOREIGN KEY(user_id)
        REFERENCES users(id) MATCH SIMPLE
            ON UPDATE NO ACTION
            ON DELETE NO ACTION
);