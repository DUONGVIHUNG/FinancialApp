...
CREATE TABLE total_balances (
 ...
 CONSTRAINT total_balances_fkey_users FOREIGN KEY (user_id)
...
CREATE TABLE balance_modes (
  ...
  created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL,
  updated_at TIMESTAMP WITHOUT TIME ZONE NOT NULL,
  CONSTRAINT balance_modes_fkey_total_balances FOREIGN KEY (total_balance_id)
...
CREATE TABLE completed_tickets (
 ...
 created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL,
 updated_at TIMESTAMP WITHOUT TIME ZONE NOT NULL,
 CONSTRAINT completed_tickets_fkey_balance_modes FOREIGN KEY (balance_mode_id)
    REFERENCES balance_modes(id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION,
 CONSTRAINT completed_tickets_fkey_users FOREIGN KEY (user_id)
    REFERENCES users(id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
);
...
CREATE TABLE future_tickets (
 ...
 created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL,
 updated_at TIMESTAMP WITHOUT TIME ZONE NOT NULL,
 CONSTRAINT future_tickets_fkey_users FOREIGN KEY (user_id)
    REFERENCES users(id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION,
 CONSTRAINT future_tickets_fkey_balance_modes FOREIGN KEY (balance_mode_id)
    REFERENCES balance_modes(id)
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
);
